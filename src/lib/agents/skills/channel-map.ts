...
export const CHANNEL_DEFINITIONS: ChannelDefinition[] = [
  ...
  },
  {
    ...
    medium: 'community',
    outputMode: 'production_package',
    deliverables: ['Show HN 提交包', '技术文章', '首条评论与回复预案'],
    locales: ['en'],
    tier: 'p1',
    postsPerWeek: 1,
    campaignDays: 30,
    defaultTaskTypes: ['research', 'show_hn', 'article', 'engage'],
  },
  {
    ...
    description: '用真实决策、实验和复盘参与独立开发者讨论，建立 builder 信任而非投放式曝光',
    medium: 'community',
    outputMode: 'publish_ready_text',
    deliverables: ['创始人故事', 'Build Log', '实验复盘', '反馈请求'],
    locales: ['en'],
    tier: 'p1',
    postsPerWeek: 1,
    campaignDays: 30,
    defaultTaskTypes: ['founder_story', 'build_log', 'experiment', 'engage'],
  },
  {
    channelId: 'tiktok',
