...
export const LAUNCH_AGENT_ARCHITECTURE: LaunchAgentDefinition[] = [
  ...
  },
  {
    ...
    userVisible: false,
    owns: 'one market strategy report, channel priorities, and four-week direction',
    reads: ['Product Profile', 'Launch Brief', 'evidence', 'router Skills'],
    writes: ['market strategy report', 'channel-native role briefs'],
  ...
  },
  {
    ...
    reads: ['market strategy report', 'evidence', 'performance signals', 'channel output rules'],
  ...
  },
  {
    ...
    reads: ['market strategy report', 'scoped channel plan', 'channel Skills', 'variant brief'],
  ...
  },
  {
    ...
    reads: ['scoped task', 'market strategy report', 'channel Skill', 'confirmed facts', 'fresh research'],
