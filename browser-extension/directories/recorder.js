(function installNowBuildDirectoryRecorder() {
  ...
  function inferKitKey(element) {
    ...
    const rules = [
      ...
      ['discordUrl', /discord/],
      ['youtubeUrl', /youtube/],
      ['demoUrl', /demo|video|walkthrough/],
      ['companyName', /company name|organization name|business name/],
      ['featureHighlights', /feature|benefit|capabilit/],
      ['supportedPlatforms', /supported platform|available on|platforms/],
      ['integrations', /integration|integrates with/],
      ['techStack', /tech stack|technolog(?:y|ies)|built with/],
      ['productStage', /product stage|startup stage|development stage/],
      ['apiAvailability', /api availab|has api|api access/],
      ['communityAvailability', /community availab|has community/],
      ['backlinkUrl', /backlink url|badge url|where.*badge|proof.*backlink/],
